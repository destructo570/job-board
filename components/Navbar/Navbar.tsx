...
const Navbar = ({ session }: NavbarProps) => {
  ...
  return (
    <nav className="w-full flex items-center justify-between h-14 border shadow-[0 0 10px hsl(var(--blue) / 1)] border-secondary rounded-lg px-2 transition-all backdrop-blur-lg bg-background">
      ...
      <Link href={"/"}>
        <h3 className="animate-text-gradient text-xl font-bold inline-flex bg-gradient-to-r from-neutral-900 via-slate-500 to-neutral-400 bg-[200%_auto] bg-clip-text leading-tight text-transparent dark:from-neutral-100 dark:via-slate-600 dark:to-neutral-400 cursor-pointer">
          100xJobs
        </h3>
      </Link>
      </div>
